...
import ToolingIcon from './icons/IconBaconDosisBurger.vue'
import EcosystemIcon from './icons/IconMiamiViceBurger.vue'
import CommunityIcon from './icons/IconSinaloaBurger.vue'
import SupportIcon from './icons/IconItalianBurger.vue'
</script>
